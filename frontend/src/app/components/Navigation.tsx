...
const Navigation = () => {
  ...
  return (
    <nav className="relative">
      ...
      {/* Subtle bottom glow */}
      <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-purple-500/20 to-transparent blur-sm"></div>
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0 group">
            <Link href="/" className="flex items-center">
              <h1 className="text-2xl font-bold text-transparent bg-clip-text animate-gradient-slow relative"
                  style={{ 
                ...
                <span className="absolute bottom-0 left-0 w-0 h-[2px] bg-gradient-to-r from-blue-500 via-purple-500 to-blue-500 
          ...
          <Link 
            ...
            className={`
              ...
              before:opacity-0 hover:before:opacity-100 before:transition-opacity before:rounded-md
              ...
              rounded-md overflow-hidden backdrop-blur-sm
            `}>
